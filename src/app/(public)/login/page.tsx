    ...
    const handleEmailLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (errorText.includes('Invalid login credentials')) {
                ...
                errorText = 'يرجى تفعيل حسابك من خلال الرابط المرسل إلى بريدك'
            }
                ...
                <div className="w-full max-w-md space-y-8">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <button
                            ...
                            className="flex items-center justify-center py-3 border border-input rounded-xl hover:bg-muted transition-colors font-medium text-foreground gap-2 disabled:opacity-50"
