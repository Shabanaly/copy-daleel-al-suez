    ...
    try {
        ...
        return (
            <div className="flex min-h-screen bg-muted/30" dir="rtl">
                {/* Desktop Sidebar */}
                <AdminDesktopSidebar variant="super-admin" subtitle="مدير النظام" isSuperAdmin />
                ...
                <div className="flex-1 flex flex-col min-w-0">
                    ...
                    <header className="lg:hidden h-14 border-b border-border bg-background/80 backdrop-blur-sm sticky top-0 z-30 flex items-center justify-between px-4 flex-shrink-0">
                        <div>
                            ...
                            <p className="text-[10px] text-primary font-bold uppercase tracking-widest leading-none">مدير النظام</p>
                        </div>
                        <AdminMobileDrawerTrigger variant="super-admin" subtitle="مدير النظام" isSuperAdmin />
                    </header>
